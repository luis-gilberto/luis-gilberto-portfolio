...
export function PrimaryNav({ isDark, toggleTheme }: PrimaryNavProps) {
  ...
  const navLinks = [
    { label: 'Portfolio', href: '/', active: window.location.pathname === '/' },
    { label: 'Timeline', href: '/timeline', active: window.location.pathname === '/timeline' },
    { label: 'Brand', href: '/brand', active: window.location.pathname === '/brand' },
    { label: 'Studio', href: '/studio', active: window.location.pathname === '/studio' },
    { label: 'Insights', href: '#insights', active: false },
    { label: 'The Hub', href: '/hub', active: window.location.pathname === '/hub' },
  ];
