...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <header class="site-header" style="border-bottom:1px solid rgba(255,255,255,0.08);height:80px;display:flex;align-items:center;position:fixed;top:0;width:100%;z-index:10000;">
        <div class="nav-container" style="max-width:1400px;margin:0 auto;width:100%;padding:0 48px;display:flex;justify-content:space-between;align-items:center;">
            ...
            <nav class="desktop-nav" style="display:flex;gap:8px;position:relative;">
                ...
                <a href="https://portal.luis-gilberto.com" class="nav-link" style="color:var(--teal) !important;font-weight:700;">The Portal</a>
    ...
    <div class="mobile-drawer" id="mobile-drawer">
        ...
        <div class="drawer-section">
            ...
            <a href="https://portal.luis-gilberto.com" class="drawer-nav-link"><span>The Portal</span><span class="dnl-arrow">›</span></a>
        </div>
    ...
    styleInject.innerHTML = `
        ...
        .mobile-menu-btn span { display: block; height: 1.5px; background: rgba(255,255,255,0.7); border-radius: 1px; transition: all 0.25s; }
        .mobile-menu-btn span:nth-child(1) { width: 16px; }
        .mobile-menu-btn span:nth-child(2) { width: 16px; }
        .mobile-menu-btn span:nth-child(3) { width: 10px; align-self: flex-end; margin-right: 10px; }
        .mobile-menu-btn.open span:nth-child(1) { transform: translateY(6.5px) rotate(45deg); }
        .mobile-menu-btn.open span:nth-child(2) { opacity: 0; }
        .mobile-menu-btn.open span:nth-child(3) { transform: translateY(-6.5px) rotate(-45deg); width: 16px; margin-right: 0; }
