 ...
 *   work pages. Logo swaps: white_lg-portfolio-logo.webp / black_lg-portfolio-logo_black.webp
 *   (portfolio surface handles light/dark swap).
 */
...
(function () {
  ...
  const css = `
    ...
    [data-theme="light"] #work-nav-header {
    ...
    .wn-inner .wn-logo-link {
      justify-self: start;
    }
    .wn-inner .wn-desktop-nav {
      justify-self: center;
      position: static;
      transform: none;
    }
    ...
    #wn-logo-desktop { display: block; height: 40px; width: auto; }
    #wn-logo-mark    { display: none; }
    ...
    /* Header CTAs */
    .wn-ctas { display: flex; align-items: center; gap: 8px; margin-left: auto; padding-right: 0; }
    .wn-theme-btn {
    ...
    @media (max-width: 1024px) {
      ...
      #wn-logo-mark    { display: block !important; height: 36px; width: auto; }
      .wn-inner {
        display: flex;
        align-items: center;
      ...
      .wn-inner .wn-logo-link { justify-self: unset; }
      .wn-inner .wn-ctas     { justify-self: unset; margin-left: auto; }
    }
    @media (max-width: 1024px) {
      .wn-context-bar { display: none; }
    }
  `;
...
<header id="work-nav-header">
  <div class="wn-inner">
    ...
    <a href="/" class="wn-logo-link">
      <img id="wn-logo-desktop" src="/assets/images/white_lg-portfolio-logo.webp" alt="Luis Gilberto Portfolio">
      <img id="wn-logo-mark"    src="/assets/images/white-3d_logomark.webp" alt="Luis Gilberto" style="display:none;">
    </a>
    ...
    <nav class="wn-desktop-nav" id="wn-desktop-nav" aria-label="Main navigation">
      ...
      <button id="wn-trigger-portal" class="wn-nav-link" aria-haspopup="true" aria-expanded="false" aria-controls="wn-panel-portal" data-wn-trigger style="padding:4px 6px;">
        <img id="wn-portal-logo" src="/assets/images/TheLGPortal_dark-mode.png" alt="The Portal" style="height:32px;width:auto;display:block;">
        ${CHEVRON}
      </button>
          ...
          <div id="wn-panel-hub" class="wn-panel">
            <div class="wn-panel-wrap wn-wide">
              ...
              <div class="wn-panel-grid-2">
                ...
                <a href="/studio/" class="wn-panel-item">
...
<div id="wn-mobile-menu">
  ...
  function applyTheme(theme) {
    ...
    // Portfolio logo swap
    const ld = document.getElementById('wn-logo-desktop');
    if (ld) ld.src = theme === 'dark'
      ? '/assets/images/white_lg-portfolio-logo.webp'
      : '/assets/images/black_lg-portfolio-logo_black.webp';
    // Logomark swap (mobile)
    const lm = document.getElementById('wn-logo-mark');
    if (lm) lm.src = theme === 'dark'
      ? '/assets/images/white-3d_logomark.webp'
      : '/assets/images/black-3d_logomark.webp';
    // Portal logo swap
  ...
  // Hide breadcrumb bar on mobile via class injection
  const contextBar = document.querySelector('.context-bar');
  if (contextBar) {
    contextBar.classList.add('wn-context-bar');
  }
