...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
      ...
      let eY = (0, eX.withAuth)(async function(e2) {
        ...
        if (e2.nextUrl.pathname.startsWith("/auth")) return r2 ? ez.NextResponse.redirect(new URL("/dashboard", e2.url)) : null;
        if (!r2) {
          let t3 = e2.nextUrl.pathname;
          return e2.nextUrl.search && (t3 += e2.nextUrl.search), ez.NextResponse.redirect(new URL(`/auth/signin?from=${encodeURIComponent(t3)}`, e2.url));
        }
      ...
      e.s(["config", 0, { matcher: ["/dashboard/:path*", "/admin/:path*", "/auth/:path*", "/projects/:path*", "/documents/:path*", "/messages/:path*"] }, "default", 0, eY], 96592);
      var eQ = e.i(96592);
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/dashboard(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/admin(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/auth(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/projects(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/documents(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/messages(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$"] }];
...
var BuildId = "hla8K2SGyLCzCjCn_BDBd";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "priority": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_global-error", "regex": "^/_global\\-error(?:/)?$", "routeKeys": {}, "namedRegex": "^/_global\\-error(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/admin", "regex": "^/admin(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin(?:/)?$" }, { "page": "/admin/clients", "regex": "^/admin/clients(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/clients(?:/)?$" }, { "page": "/admin/projects", "regex": "^/admin/projects(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/projects(?:/)?$" }, { "page": "/api/admin/clients", "regex": "^/api/admin/clients(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/clients(?:/)?$" }, { "page": "/api/assessment/session", "regex": "^/api/assessment/session(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/assessment/session(?:/)?$" }, { "page": "/api/assessment/session/update", "regex": "^/api/assessment/session/update(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/assessment/session/update(?:/)?$" }, { "page": "/auth/signin", "regex": "^/auth/signin(?:/)?$", "routeKeys": {}, "namedRegex": "^/auth/signin(?:/)?$" }, { "page": "/auth/signup", "regex": "^/auth/signup(?:/)?$", "routeKeys": {}, "namedRegex": "^/auth/signup(?:/)?$" }, { "page": "/auth/verify-request", "regex": "^/auth/verify\\-request(?:/)?$", "routeKeys": {}, "namedRegex": "^/auth/verify\\-request(?:/)?$" }, { "page": "/changelog", "regex": "^/changelog(?:/)?$", "routeKeys": {}, "namedRegex": "^/changelog(?:/)?$" }, { "page": "/dashboard", "regex": "^/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/dashboard(?:/)?$" }, { "page": "/documents", "regex": "^/documents(?:/)?$", "routeKeys": {}, "namedRegex": "^/documents(?:/)?$" }, { "page": "/favicon.ico", "regex": "^/favicon\\.ico(?:/)?$", "routeKeys": {}, "namedRegex": "^/favicon\\.ico(?:/)?$" }, { "page": "/messages", "regex": "^/messages(?:/)?$", "routeKeys": {}, "namedRegex": "^/messages(?:/)?$" }, { "page": "/projects", "regex": "^/projects(?:/)?$", "routeKeys": {}, "namedRegex": "^/projects(?:/)?$" }, { "page": "/projects/new", "regex": "^/projects/new(?:/)?$", "routeKeys": {}, "namedRegex": "^/projects/new(?:/)?$" }, { "page": "/strategyiq", "regex": "^/strategyiq(?:/)?$", "routeKeys": {}, "namedRegex": "^/strategyiq(?:/)?$" }], "dynamic": [{ "page": "/admin/projects/[id]", "regex": "^/admin/projects/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/admin/projects/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/auth/[...nextauth]", "regex": "^/api/auth/(.+?)(?:/)?$", "routeKeys": { "nxtPnextauth": "nxtPnextauth" }, "namedRegex": "^/api/auth/(?<nxtPnextauth>.+?)(?:/)?$" }, { "page": "/projects/[projectId]", "regex": "^/projects/([^/]+?)(?:/)?$", "routeKeys": { "nxtPprojectId": "nxtPprojectId" }, "namedRegex": "^/projects/(?<nxtPprojectId>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge/chunks/node_modules_next_dist_esm_build_templates_edge-wrapper_78fa9d6a.js", "server/edge/chunks/[root-of-the-server]__bae33f1d._.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_b2bddd2a.js"], "name": "middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/dashboard(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$", "originalSource": "/dashboard/:path*" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/admin(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$", "originalSource": "/admin/:path*" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/auth(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$", "originalSource": "/auth/:path*" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/projects(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$", "originalSource": "/projects/:path*" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/documents(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$", "originalSource": "/documents/:path*" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/messages(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$", "originalSource": "/messages/:path*" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "hla8K2SGyLCzCjCn_BDBd", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "H552M4BvV6R56oiDH6TkdNbfnhIYFb9mank5Wklq6EY=", "__NEXT_PREVIEW_MODE_ID": "f19f9b5037cc97d6ce4fff562dba0ac8", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "ac5e8124a12a8cb7f7c816cab94cadbda95e6ee74ce9122a84c2b54266d70e49", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "bcde565d30eaa0a23c740a4560b1667b16270439e114b751353211da8aff8fc4" } } }, "sortedMiddleware": ["/"], "functions": {} };
var AppPathRoutesManifest = { "/_global-error/page": "/_global-error", "/_not-found/page": "/_not-found", "/admin/clients/page": "/admin/clients", "/admin/page": "/admin", "/admin/projects/[id]/page": "/admin/projects/[id]", "/admin/projects/page": "/admin/projects", "/api/admin/clients/route": "/api/admin/clients", "/api/assessment/session/route": "/api/assessment/session", "/api/assessment/session/update/route": "/api/assessment/session/update", "/api/auth/[...nextauth]/route": "/api/auth/[...nextauth]", "/auth/signin/page": "/auth/signin", "/auth/signup/page": "/auth/signup", "/auth/verify-request/page": "/auth/verify-request", "/changelog/page": "/changelog", "/dashboard/page": "/dashboard", "/documents/page": "/documents", "/favicon.ico/route": "/favicon.ico", "/messages/page": "/messages", "/page": "/", "/projects/[projectId]/page": "/projects/[projectId]", "/projects/new/page": "/projects/new", "/projects/page": "/projects", "/strategyiq/page": "/strategyiq" };
