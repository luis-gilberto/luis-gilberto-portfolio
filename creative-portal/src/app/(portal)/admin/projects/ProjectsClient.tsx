...
export default function ProjectsClient({ projects, authorityLevel }: ProjectsClientProps) {
  const [isAddModalOpen, setIsAddProjectModalOpen] = useState(false);
    ...
    <div className="p-4 md:p-8 max-w-[1600px] mx-auto text-white">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 md:mb-12 gap-4">
        ...
        <Button 
          ...
          className="hidden md:flex bg-[#F96F6E] hover:bg-[#ff8584] text-white gap-2 font-bold font-display uppercase tracking-wider"
        >
      ...
      <button 
        onClick={() => setIsAddProjectModalOpen(true)}
        className="md:hidden fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-[#F96F6E] hover:bg-[#ff8584] shadow-lg shadow-coral/30 flex items-center justify-center text-[#050505] transition-transform active:scale-95"
      >
