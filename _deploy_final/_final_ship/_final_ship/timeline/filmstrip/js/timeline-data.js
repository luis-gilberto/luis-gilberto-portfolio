...
window.timelineData = {
  foundations: {
    ...
    brandsSupported: {
      ...
      image: { src: "assets/images/Brands_I_Supported_Foundations.png", alt: "Brands Supported — Foundations Era" }
    }
  },
  ascent: {
    ...
    brandsSupported: {
      title: "Brands I Supported",
      image: { src: "assets/images/Brands_I_Supported_Ascent.png", alt: "Brands Supported — Ascent Era" }
    }
  },
  rewrite: {
    ...
    brandsSupported: {
      title: "Brands I Supported",
      image: { src: "assets/images/Brands_I_Supported_Rewrite.png", alt: "Brands Supported — Rewrite Era" }
    }
  },
  pivot: {
    ...
    brandsSupported: {
      title: "Brands I Supported",
      image: { src: "assets/images/Brands_I_Supported_Pivot.png", alt: "Brands Supported — Pivot Era" }
    }
  },
  rise: {
    ...
    brandsSupported: {
      title: "Brands I Supported",
      image: { src: "assets/images/Brands_I_Supported_Rise.png", alt: "Brands Supported — Rise Era" }
    }
  },
  reinvention: {
    ...
    brandsSupported: {
      title: "Brands I Supported",
      image: { src: "assets/images/Brands_I_Supported_Reinvention.png", alt: "Brands Supported — Reinvention Era" }
    }
  }
};
