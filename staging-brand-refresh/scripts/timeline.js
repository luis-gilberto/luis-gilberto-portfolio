...
const timelineData = {
    ...
    reinvention: {
        ...
        achievements: [
            ...
            "<strong><a href='https://luis-gilberto.com/insights/' target='_blank' style='color: inherit; text-decoration: underline;'>Personal Insights & Learnings</a></strong> - Reflections on career transitions and creative renaissance"
        ],
        brands: [
